...
const Landing = () => {
  return (
    <section className="w-full bg-landing flex flex-col items-center max-w-full overflow-hidden relative h-[100vh] min-h-[800px] px-4 md:px-10 max-[1000px]:pb-[240px]">
