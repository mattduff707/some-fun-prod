    ...
    <PageWrap className="bg-seawater">
      <div className="relative flex w-full max-w-constraint flex-col items-center pb-20">
        ...
        <Image
          ...
          className="z-[2] mt-8 h-auto w-[55%] origin-top-left rotate-[4deg] self-end rounded-[30px] border-common border-seaweed shadow-box shadow-seawaterShadow"
        />
        <div className="z-[1] flex items-end justify-between">
          <Image
            ...
            className="h-auto w-[55%] shrink-0 origin-top-left rotate-[-6deg] rounded-[30px] border-common border-seaweed shadow-box shadow-seaweedShadow"
          />
          <Image
            width={359}
            height={317}
